...
# Internal Imports
from dataset.path_omic_dataset_eval import classification_dataset
...
parser.add_argument('--data_root_dir',   type=str, default=r'/home/qiyuan/nvme0n1/WMK/UNI/ALL_PT',
...
parser.add_argument('--results_dir',     type=str, default=r'./eval_brca_result_shandong',
                    help='Results directory (Default: ./results)')
parser.add_argument('--which_splits',    type=str, default=r'shangdong',
                    help='Which splits folder to use in ./splits/ (Default: ./splits/5foldcv')
parser.add_argument('--split_dir',       type=str, default='PR',
...
parser.add_argument('--path_load_model', type=str,
                    default='brca_result_new/5foldcv/ONLINE_KD_CrossEntropyLoss_5foldcv_gc16_topk8192_auc_bilinear/PR_SP_KL_OR_ONLINE_KD_CrossEntropyLoss_5foldcv_gc16_topk8192_auc_bilinear_temp6_s1', help= 'path of ckpt for loading')
...
### Model Parameters.
parser.add_argument('--model_type',      type=str, choices=['mul_kd', 'mul_abmil_snn', 'online_kd', 'batch_kd', 'abmil', 'dtft', 'clam_sb', 'clam_mb', 'rrt', 'WIKG'
                                                            'TransMIL', 'fof', 'cmta_path', 'mamba2mil', 'GEE'], 
                    default=r'online_kd', help='Type of model (Default: motcat)')
...
parser.add_argument('--temp',   action='store_true', default=6, help='Temperature coefficient (t=8)')
...
def main(args):
    ...
    for i in range(start, folds):
        ...
        # args.results_pt_path = os.path.join(
        #     args.results_dir, 's_{}_min_loss_checkpoint.pt'.format(i))
        if args.stage == 'test':
        ...
        if args.stage == 'test':
            test_summary_results, test_print_results = test(datasets, i, "s_{}.pt".format(i), args)
