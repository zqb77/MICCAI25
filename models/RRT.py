...
from models.model_utils.emb_position import *
from models.model_utils.datten import *
from models.model_utils.rmas import *
...
class RRTMIL(nn.Module):
    ...
    def forward(self, return_attn=False,no_norm=False, **kwargs):
        x = kwargs['x_path']
